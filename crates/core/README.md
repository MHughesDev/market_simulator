...
Core foundational types and utilities for [Market Simulator](https://market-simulator).

The `nautilus-core` crate is designed to be lightweight, efficient, and to provide zero-cost abstractions
wherever possible. It supplies the essential building blocks used across the Market Simulator
ecosystem, including:
