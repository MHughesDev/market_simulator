...
Data engine and market data processing for [Market Simulator](https://market-simulator).

The `nautilus-data` crate provides a framework for handling market data ingestion,
processing, and aggregation within the Market Simulator ecosystem. This includes real-time
