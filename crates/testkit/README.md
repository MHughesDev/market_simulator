...
Test utilities and data management for [Market Simulator](https://market-simulator).
...
across the entire Market Simulator ecosystem with automated data downloads and validation:
