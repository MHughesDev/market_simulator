...
Ensure that the `market_simulator` package is either compiled from source or installed via pip before
running the examples. See the [installation guide](docs/getting_started/installation)
